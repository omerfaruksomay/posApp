...
class TableController extends Controller
{
    ...
    {
        $tables = Table::all();
        return view('management.table.table')->with('tables', $tables);
    }
    ...
    {
        return view('management.table.create_table');
    }
    ...
    {
        $table = Table::find($id);
        return view('management.table.edit_table')->with('table', $table);
    }
