...
class MenuController extends Controller
{
    ...
    {
        $menus = Menu::all();
        return view('management.menu.menu')->with('menus', $menus);
    }
    ...
    public function create()
    {
        ...
        return view('management.menu.create_menu')->with('categories', $categories);
    }
    ...
    public function edit(string $id)
    {
        $menu = Menu::find($id);
        $categories = Category::all();
        return view('management.menu.edit_menu')->with('menu', $menu)->with('categories', $categories);
    }
